...
?>
	...
	<?php if($total<=5000){?>
	<div align="right"><a href = "#" onclick= <?php echo 'window.open("tweetdownloadexcel.php?query='.$excelquery.'&sz=small"); return false;'; ?> style="text-align:left"><img src="inc/images/excel.png" target="_blank">&nbsp;Download as Excel</a></div>
	<div align="right"><a href = "#" onclick= <?php echo 'copyToClipboard("tweetdownloadexcel.php?query='.$excelquery.'&sz=small")'; ?> style="text-align:left"><i>Copy Download To Clipboard</i></a></div>
	<?php }else{ ?>
